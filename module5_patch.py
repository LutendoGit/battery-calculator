...
# 1) Add Module 5 content and assessment to lithium_education.py
path = root / 'modules' / 'lithium_education.py'
    ...
    "sections": [
        ...
        },
        {
            ...
            "bullets_after": [
                ...
                "Modern lithium systems rely on CAN Bus, RS485 or Modbus for communication.",
...
class CapacityAndDOD:
'''
assert old in text, 'old pattern not found in lithium_education.py'
text = text.replace(old, new)
path.write_text(text, encoding='utf-8')

# 2) Add Module 5 import and quiz integration in routes
path = root / 'routes' / 'education_routes.py'
text = path.read_text(encoding='utf-8')
text = text.replace(
...
needle = '''@education_bp.route('/fundamentals/module-4')
...
'''
new_route = '''@education_bp.route('/fundamentals/module-4')
def fundamentals_module4():
    """Fundamentals Module 4: Battery Management System (BMS)"""
    content = MODULE_4_BMS
...
@education_bp.route('/chemistry')
'''
assert needle in text, 'fundamentals_module4 block not found in education_routes.py'
text = text.replace(needle, new_route)

needle_api = '''@education_bp.route('/api/quiz/module-4-assessment')
@api_login_required
...
'''
new_api = '''@education_bp.route('/api/quiz/module-4-assessment')
@api_login_required
def api_quiz_module_4_assessment():
    """API: Get Module 4 assessment quiz."""
    user = _current_user()
...
@education_bp.route("/api/quiz/unlock-state")
'''
assert needle_api in text, 'module-4 API block not found in education_routes.py'
text = text.replace(needle_api, new_api)

path.write_text(text, encoding='utf-8')

# 3) Add quiz card and JS metadata to quiz_index.html
path = root / 'templates' / 'education' / 'quiz_index.html'
text = path.read_text(encoding='utf-8')
text = text.replace(
    '            <div class="quiz-card" data-quiz-id="module-4-assessment">\n                <div class="quiz-icon">🛡️</div>\n                <h2>Module 4 Assessment Quiz</h2>\n                <p>Battery Management System (BMS) (Module 4)</p>\n                <p>25 questions • Pass mark 75%</p>\n                <div class="pos-row" data-quiz-pos></div>\n                <div class="lock-row" data-lock-row hidden><span data-lock-icon>🔒</span><span data-lock-text>Locked</span></div>\n                <button type="button" onclick="startQuiz('module-4-assessment')">Start Quiz</button>\n            </div>\n        </div>\n',
    '            <div class="quiz-card" data-quiz-id="module-4-assessment">\n                <div class="quiz-icon">🛡️</div>\n                <h2>Module 4 Assessment Quiz</h2>\n                <p>Battery Management System (BMS) (Module 4)</p>\n                <p>25 questions • Pass mark 75%</p>\n                <div class="pos-row" data-quiz-pos></div>\n                <div class="lock-row" data-lock-row hidden><span data-lock-icon>🔒</span><span data-lock-text>Locked</span></div>\n                <button type="button" onclick="startQuiz('module-4-assessment')">Start Quiz</button>\n            </div>\n            <div class="quiz-card" data-quiz-id="module-5-assessment">\n                <div class="quiz-icon">📐</div>\n                <h2>Module 5 Assessment Quiz</h2>\n                <p>Energy System Design & Sizing (Module 5)</p>\n                <p>25 questions • Pass mark 75%</p>\n                <div class="pos-row" data-quiz-pos></div>\n                <div class="lock-row" data-lock-row hidden><span data-lock-icon>🔒</span><span data-lock-text>Locked</span></div>\n                <button type="button" onclick="startQuiz('module-5-assessment')">Start Quiz</button>\n            </div>\n        </div>\n'
)
text = text.replace(
    "        const QUIZ_TITLES = {\n            'capacity-dod': 'Module 1 Assessment Quiz',\n            'module-2-assessment': 'Module 2 Assessment Quiz',\n            'module-3-assessment': 'Module 3 Assessment Quiz',\n            'module-4-assessment': 'Module 4 Assessment Quiz'\n        };\n\n        const PASS_MARKS = {\n            'capacity-dod': 75,\n            'module-2-assessment': 75,\n            'module-3-assessment': 75,\n            'module-4-assessment': 75\n        };\n\n        const QUIZ_REQUIREMENTS = {\n            'capacity-dod': 'Fundamentals (Module 1)',\n            'module-2-assessment': 'Fundamentals (Module 2)',\n            'module-3-assessment': 'Fundamentals (Module 3)',\n            'module-4-assessment': 'Fundamentals (Module 4)'\n        };\n\n        const QUIZ_ORDER = [\n            'capacity-dod',\n            'module-2-assessment',\n            'module-3-assessment',\n            'module-4-assessment'\n        ];\n\n        const NEXT_MODULE_URLS = {\n            'capacity-dod': "{{ url_for('education.fundamentals_module2') }}",\n            'module-2-assessment': "{{ url_for('education.fundamentals_module3') }}",\n            'module-3-assessment': "{{ url_for('education.fundamentals_module4') }}",\n            'module-4-assessment': "{{ url_for('education.learn_index', hub=1) }}"\n        };\n",
    "        const QUIZ_TITLES = {\n            'capacity-dod': 'Module 1 Assessment Quiz',\n            'module-2-assessment': 'Module 2 Assessment Quiz',\n            'module-3-assessment': 'Module 3 Assessment Quiz',\n            'module-4-assessment': 'Module 4 Assessment Quiz',\n            'module-5-assessment': 'Module 5 Assessment Quiz'\n        };\n\n        const PASS_MARKS = {\n            'capacity-dod': 75,\n            'module-2-assessment': 75,\n            'module-3-assessment': 75,\n            'module-4-assessment': 75,\n            'module-5-assessment': 75\n        };\n\n        const QUIZ_REQUIREMENTS = {\n            'capacity-dod': 'Fundamentals (Module 1)',\n            'module-2-assessment': 'Fundamentals (Module 2)',\n            'module-3-assessment': 'Fundamentals (Module 3)',\n            'module-4-assessment': 'Fundamentals (Module 4)',\n            'module-5-assessment': 'Fundamentals (Module 5)'\n        };\n\n        const QUIZ_ORDER = [\n            'capacity-dod',\n            'module-2-assessment',\n            'module-3-assessment',\n            'module-4-assessment',\n            'module-5-assessment'\n        ];\n\n        const NEXT_MODULE_URLS = {\n            'capacity-dod': "{{ url_for('education.fundamentals_module2') }}",\n            'module-2-assessment': "{{ url_for('education.fundamentals_module3') }}",\n            'module-3-assessment': "{{ url_for('education.fundamentals_module4') }}",\n            'module-4-assessment': "{{ url_for('education.fundamentals_module5') }}",\n            'module-5-assessment': "{{ url_for('education.learn_index', hub=1) }}"\n        };\n"
)
path.write_text(text, encoding='utf-8')

# 4) Add Module 5 builder method
path = root / 'modules' / 'interactive_tools.py'
text = path.read_text(encoding='utf-8')
needle = '''    @staticmethod
    def quiz_module_4_assessment() -> List[Dict]:
        """Module 4 assessment: The Battery Management System (BMS)."""
        from modules.lithium_education import MODULE_4_ASSESSMENT

        questions = []
        for q in MODULE_4_ASSESSMENT.get("questions", []):
...
new = '''    @staticmethod
    ...
    @staticmethod
    def quiz_module_5_assessment() -> List[Dict]:
        """Module 5 assessment: Energy System Design & Sizing."""
        from modules.lithium_education import MODULE_5_ASSESSMENT

        questions = []
        for q in MODULE_5_ASSESSMENT.get("questions", []):
            answer_map = {'A': 0, 'B': 1, 'C': 2, 'D': 3}
            correct_index = answer_map.get(q.get("answer"), 0)
            questions.append({
                "question": q.get("question"),
    ...
    @staticmethod
'''
assert needle in text, 'module_4 builder block not found in interactive_tools.py'
